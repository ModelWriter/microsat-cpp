...
constexpr int mem_max = 1 << 30; // the initial maximum memory
constexpr int ave_max = 1 << 24; // the initial average

enum state { END = -9, UNSAT = 0, SAT = 1, MARK = 2, IMPLIED = 6 };
...
class Solver {
  private:
    ...
    int* falseStack = nullptr; // Stack of falsified literals
